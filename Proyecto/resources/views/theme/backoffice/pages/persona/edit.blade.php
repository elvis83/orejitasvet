...
@section('content')
	...
	<div class="section">
		<p class="caption">Modifique los datos personales.</p>
		...
		<div id="basic-form" class="section">
			<div class="row">
				<div class="col s12 m8 offset-m2">
					...
					<span class="card-title">Editar datos personales</span>
					<div class="row">
					<form class="col s12" method="post" action="{{ route('backoffice.persona.update', $persona) }}">
						...
						<div class="row">
							<div class="input-field col s3">
								<input id="per_apepat" type="text" name="per_apepat" value="{{ $persona->per_apepat }}">
							...
							<div class="input-field col s3">
								<input id="per_apemat" type="text" name="per_apemat" value="{{ $persona->per_apemat }}">
							...
							<div class="input-field col s6">
								<input id="per_nombres" type="text" name="per_nombres" value="{{ $persona->per_nombres }}">
						...
						<div class="row">
							<div class="input-field col s2">
								<select name="tipd_id">
									<option value="{{ $persona->tipd_id }}" selected="">{{ $persona->tipodocumento->tipd_abreviatura }}</option>

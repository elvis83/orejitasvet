...
@section('breadcrumbs')
	<li><a href="{{ route('backoffice.diagnostico.index') }}">Diagnósticos</a></li>
	<li class="active">Crear diagnóstico</li>
@endsection

@section('content')
	
	<div class="section">
		<p class="caption">Introduce los datos de las diagnóstico.</p>
		...
		<div id="basic-form" class="section">
			<div class="row">
				<div class="col s12 m8 offset-m2">
					...
					<span class="card-title">Crear diagnóstico</span>
					<div class="row">
					<form class="col s12" method="post" action="{{ route('backoffice.diagnostico.store') }}">
